...
A short history of how Gateaux got here. Dates are from file stamps and conversation history, not a formal release train.

| When | What happened | Why it matters |
|---|---|---|
| Sep 2025 | GDD v2 and character bible written | The *idea* is strong: five cats, café as classroom, formal vs slang as the joke |
...
- A real playtest with a stranger
